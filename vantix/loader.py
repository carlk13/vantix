...
from ._vantix import load_images_fast

class vantixLoader(IterableDataset):
    def __init__(self, image_paths, width=224, height=224, batch_size=64, 
                 augment=False, shuffle=True, transform=None, queue_size=3):
